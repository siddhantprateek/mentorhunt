...
To contribute to Rteach, go through the following steps
...
```
git remote add upstream https://github.com/rteach/rteach.git
``` 
("rteach" is used as the example repo. Be sure to reference the _actual_ repo you're contributing to e.g. "rteach-linkerd").
...
This repository and site are available as open-source under the terms of the [BSD 2-Clause License](/LICENSE).
